...
class AbsensiGuruModel extends Model
{
    ...
    public function getAbsensiByKegiatan($idKegiatan)
    {
        // Use raw query to handle collation mismatch safely
        $sql = "SELECT tbl_absensi_guru.*, tbl_guru.Nama as NamaGuru, tbl_guru.NoHp, tbl_guru.KelurahanDesa, tbl_tpq.NamaTpq
                ...
                WHERE IdKegiatan = ?
                ORDER BY tbl_guru.Nama ASC";

        return $this->db->query($sql, [$idKegiatan])->getResultObject();
    }
}
