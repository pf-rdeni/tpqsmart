...
class AbsensiGuruModel extends Model
{
    ...
    public function getAbsensiByKegiatan($idKegiatan, $idTpq = null, $tanggalOccurrence = null)
    {
        ...
        $sql = "SELECT tbl_absensi_guru.*, tbl_guru.Nama as NamaGuru, tbl_guru.NoHp, tbl_tpq.KelurahanDesa as KelurahanDesa, tbl_guru.JenisKelamin, tbl_guru.LinkPhoto, tbl_tpq.NamaTpq
                ...
                WHERE IdKegiatan = ? AND tbl_guru.Status = 1";
