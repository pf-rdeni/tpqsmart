                            ...
                            <div class="card-body">
                                ...
                                $semesterList = [
                                    'Ganjil' => [
                                        ...
                                        'data' => $StatistikProgressNilaiPerKelas['Ganjil'] ?? []
                                    ],
                                    'Genap' => [
                                        'isActive' => $isSemesterGenap,
                                        'data' => $StatistikProgressNilaiPerKelas['Genap'] ?? []
                                    ]
                                ];
                                ?>
                                ...
                                <?php foreach ($semesterList as $semester => $semesterData): ?>
                                    ...
                                    <div class="mb-4">
                                        <div class="card card-outline card-secondary <?= !$semesterData['isActive'] ? 'collapsed-card' : '' ?>">
                                            <div class="card-header">
                                                <h5 class="mb-0">
                                                    <i class="fas fa-book-reader"></i> Semester <?= $semester ?> TA <?= esc($TahunAjaran ?? '') ?>
                                                </h5>
                                                <div class="card-tools">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <table id="tabelProgressNilai<?= $semester ?>" class="table table-bordered table-striped table-hover">
                                                        ...
                                                        <tbody>
                                                            <?php if (!empty($semesterData['data'])): ?>
                                                                <?php foreach ($semesterData['data'] as $kelas): ?>
                                                                    <?php
                                                            ...
                                                            <?php else: ?>
                                                                <tr>
                                                                    <td colspan="5" class="text-center">Tidak ada data untuk semester <?= $semester ?></td>
                                                                </tr>
                                                            <?php endif; ?>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <!-- Action Buttons -->
                                                <div class="row mt-3">
                                                    <?php if ($semesterData['isActive']): ?>
                                                        <div class="col-6 col-md-3 mb-2">
                                                            <a href="<?= base_url('backend/nilai/showSantriPerKelas/' . $semester) ?>" class="btn btn-block btn-primary btn-sm mobile-btn">
                                                    ...
                                                    <?php endif; ?>
                                                    <div class="col-6 col-md-3 mb-2">
                                                        <a href="<?= base_url('backend/nilai/showDetailNilaiSantriPerKelas/' . $semester) ?>" class="btn btn-block btn-success btn-sm mobile-btn">
                                                    ...
                                                    <div class="col-6 col-md-3 mb-2">
                                                        <a href="<?= base_url('backend/nilai/showRanking/' . $semester) ?>" class="btn btn-block btn-info btn-sm mobile-btn">
                                                            <i class="fas fa-trophy"></i>
                                                    ...
                                                    <div class="col-6 col-md-3 mb-2">
                                                        <a href="<?= base_url('backend/rapor/index/' . $semester) ?>" class="btn btn-block btn-warning btn-sm mobile-btn">
                                                            <i class="fas fa-file-alt"></i>
