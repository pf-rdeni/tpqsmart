            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Informasi Profil Lembaga FKDT</h3>
                        <?php if (!empty($fkdt)) : ?>
                            <div class="card-tools">
                                <a href="<?= base_url('backend/fkdt/print-profil-lembaga/' . $fkdt[0]['IdFkdt']) ?>" class="btn btn-danger btn-sm" target="_blank">
                                    <i class="fas fa-file-pdf"></i> Print PDF
                                </a>
                                <a href="<?= base_url('backend/fkdt/edit/' . $fkdt[0]['IdFkdt']) ?>" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i> Edit Profil FKDT
                                </a>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($fkdt)) : ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>ID FKDT:</label>
                                        <p class="form-control-static"><?= $fkdt[0]['IdFkdt'] ?></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nama FKDT:</label>
                                        <p class="form-control-static"><?= $fkdt[0]['NamaFkdt'] ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Alamat:</label>
                                        <p class="form-control-static"><?= $fkdt[0]['Alamat'] ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <p class="form-control-static"><?= $fkdt[0]['TahunBerdiri'] ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>No. HP:</label>
                                        <p class="form-control-static"><?= $fkdt[0]['NoHp'] ?? '-' ?></p>
                                    </div>
                                </div>
                            </div>

                            <?php if (!empty($fkdt[0]['Visi']) || !empty($fkdt[0]['Misi'])) : ?>
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <?php if (!empty($fkdt[0]['Visi'])) : ?>
                                            <div class="mb-3">
                                                <label class="font-weight-bold">Visi Lembaga:</label>
                                                <div>
                                                    <?= formatVisi($fkdt[0]['Visi']) ?>
                                                </div>
                                            </div>
                                        <?php endif; ?>

                                        <?php if (!empty($fkdt[0]['Misi'])) : ?>
                                            <div class="mb-3">
                                                <label class="font-weight-bold">Misi Lembaga:</label>
                                                <div>
                                                    <?= formatMisi($fkdt[0]['Misi']) ?>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                        ...
                        <?php else : ?>
                            <div class="alert alert-warning">
                                ...
                                Belum ada data FKDT yang tersimpan. Silakan tambahkan data FKDT terlebih dahulu.
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h3 class="card-title"><i class="fas fa-image"></i> Logo Lembaga FKDT</h3>
                    </div>
                    <div class="card-body">
                        <div class="text-center">
                            <?php if (!empty($fkdt) && !empty($fkdt[0]['LogoLembaga'])) : ?>
                                <img id="previewLogo" src="<?= base_url('uploads/logo/' . $fkdt[0]['LogoLembaga']) ?>"
                                    alt="Logo Lembaga FKDT"
                                    class="img-fluid"
                                    style="max-height: 200px; max-width: 200px;">
                            <?php else : ?>
                                <div class="border p-4 text-muted">
                                    <i class="fas fa-image fa-3x"></i>
                                    <p>Belum ada logo FKDT</p>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <form id="formUploadLogo" class="mt-3">
                            <?php if (!empty($fkdt)) : ?>
                                <input type="hidden" name="IdFkdt" id="IdFkdtLogo" value="<?= $fkdt[0]['IdFkdt'] ?>">
                            <?php endif; ?>
                            <div class="form-group">
                                <label for="logo">Upload Logo FKDT Baru:</label>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <h3 class="card-title"><i class="fas fa-file-image"></i> Kop Lembaga FKDT</h3>
                    </div>
                    <div class="card-body">
                        <div class="text-center">
                            <?php if (!empty($fkdt) && !empty($fkdt[0]['KopLembaga'])) : ?>
                                <img id="previewKop" src="<?= base_url('uploads/kop/' . $fkdt[0]['KopLembaga']) ?>"
                                    alt="Kop Lembaga FKDT"
                                    class="img-fluid"
                                    style="max-height: 200px; max-width: 100%;">
                            <?php else : ?>
                                <div class="border p-4 text-muted">
                                    <i class="fas fa-file-image fa-3x"></i>
                                    <p>Belum ada kop lembaga FKDT</p>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <form id="formUploadKop" class="mt-3">
                            <?php if (!empty($fkdt)) : ?>
                                <input type="hidden" name="IdFkdt" id="IdFkdt" value="<?= $fkdt[0]['IdFkdt'] ?>">
                            <?php endif; ?>
                            <div class="form-group">
                                <label for="kop_lembaga">Upload Kop FKDT Baru:</label>
                                <small class="form-text text-muted d-block mb-2">
    ...
    function uploadLogo() {
        ...
        canvas.toBlob(function(blob) {
            ...
            reader.onload = function(e) {
                ...
                const idFkdt = document.getElementById('IdFkdtLogo')?.value;
                if (idFkdt) {
                    formData.append('IdFkdt', idFkdt);
                }
                ...
                $.ajax({
                    url: '<?= base_url('backend/fkdt/upload-logo') ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
    ...
    function uploadKop() {
        ...
        canvas.toBlob(function(blob) {
            ...
            reader.onload = function(e) {
                ...
                const idFkdt = document.getElementById('IdFkdt')?.value;
                if (idFkdt) {
                    formData.append('IdFkdt', idFkdt);
                }
                ...
                $.ajax({
                    url: '<?= base_url('backend/fkdt/upload-kop') ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
