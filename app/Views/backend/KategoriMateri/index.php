            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Kategori Materi</h3>
...
$(document).ready(function() {
    ...
    $('#formAddKategori').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?= base_url('backend/kategori-materi/saveKategoriMateri') ?>',
            type: 'POST',
            data: $(this).serialize(),
            dataType: 'json',
    ...
    $('#formEditKategori').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?= base_url('backend/kategori-materi/updateKategoriMateri/') ?>' + id,
            type: 'POST',
            data: $(this).serialize(),
            dataType: 'json',
            success: function(response) {
    ...
    function loadData() {
        $.ajax({
            url: '<?= base_url('backend/kategori-materi/get-kategori-materi') ?>',
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                if (response.success) {
    ...
    window.deleteKategori = function(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?= base_url('backend/kategori-materi/deleteKategoriMateri/') ?>' + id,
                    type: 'DELETE',
                    dataType: 'json',
                    success: function(response) {
                        if (response.success) {
