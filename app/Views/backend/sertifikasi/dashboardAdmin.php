                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert" style="background-color: #ffc107; color: #000; border-color: #ffc107;">
                            ...
                            <p style="color: #000;">Assalamu'alaikum, <strong><?= esc(user()->username ?? 'Admin') ?></strong>!</p>
                            <p style="color: #000;">Anda login sebagai <strong>Admin</strong>. Dashboard ini menampilkan statistik dan monitoring keseluruhan proses sertifikasi guru.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                <div class="small-box bg-info">
                    ...
                    <a href="<?= $menu_items['list_peserta'] ?>" class="small-box-footer">
        ...
        <div class="row">
            <div class="col-lg-4 col-6">
                <div class="small-box bg-primary">
                    ...
                    <a href="<?= $menu_items['list_juri'] ?>" class="small-box-footer">
                        Lihat Detail <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-6">
                <div class="small-box bg-danger">
                    ...
                    <a href="<?= $menu_items['list_nilai'] ?>" class="small-box-footer">
                        Lihat Detail <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        $progressPercent = $total_peserta > 0
                            ? round(($peserta_sudah_test / $total_peserta) * 100)
                            : 0;
                        ?>
                        ...
                        <p class="text-center">
                            <strong><?= $peserta_sudah_test ?></strong> dari <strong><?= $total_peserta ?></strong> peserta telah mengikuti test
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 col-sm-6 mb-3">
                                <a href="<?= $menu_items['list_peserta'] ?>" class="btn btn-info btn-block btn-lg">
                                    <i class="fas fa-list"></i><br>List Peserta Sertifikasi
                                </a>
                            </div>
                            <div class="col-md-4 col-sm-6 mb-3">
                                <a href="<?= $menu_items['list_nilai'] ?>" class="btn btn-success btn-block btn-lg">
                                    <i class="fas fa-chart-line"></i><br>List Nilai Sertifikasi
                                </a>
                            </div>
                            <div class="col-md-4 col-sm-6 mb-3">
                                <a href="<?= $menu_items['list_juri'] ?>" class="btn btn-warning btn-block btn-lg">
                                    <i class="fas fa-user-check"></i><br>Data Juri Sertifikasi
                                </a>
                            </div>
                        </div>
                    </div>
