...
$(document).ready(function() {
    ...
    function renderTable(data, grandTotal) {
            ...
            if (prevTanggal !== null && prevTanggal !== currentTanggal) {
                ...
                if (subtotalPagi > 0) {
                    tbody.append(`<tr style="background-color: #ffc107;">
                        <td colspan="5" style="text-align: right; font-weight: bold;">Sub ${subtotalPagi}</td>
                        <td colspan="2"></td>
                    </tr>`);
                ...
                if (subtotalSiang > 0) {
                    tbody.append(`<tr style="background-color: #ffc107;">
                        <td colspan="5" style="text-align: right; font-weight: bold;">Sub ${subtotalSiang}</td>
                        <td colspan="2"></td>
                    </tr>`);
                ...
                if (subtotalPerTanggal > 0) {
                    tbody.append(`<tr style="background-color: #90EE90;">
                        <td colspan="5" style="text-align: right; font-weight: bold;">Sub Total ${subtotalPerTanggal}</td>
                        <td colspan="2"></td>
                    </tr>`);
        ...
        tbody.append(`<tr style="background-color: #90EE90;">
            <td colspan="5" style="text-align: right; font-weight: bold;">Grand Total ${grandTotalCalc}</td>
            <td colspan="2"></td>
        </tr>`);
    }
