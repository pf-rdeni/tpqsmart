...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Nilai Munaqosah</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form Edit Nilai Munaqosah</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('backend/munaqosah/update-nilai/' . $nilai->id) ?>" method="post">
                                <?= csrf_field() ?>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="KategoriMateriUjian" name="KategoriMateriUjian" required>
                                                ...
                                                <option value="Iqra" <?= old('KategoriMateriUjian', $nilai->KategoriMateriUjian) == 'Iqra' ? 'selected' : '' ?>>Iqra</option>
                                                <option value="Qur'an" <?= old('KategoriMateriUjian', $nilai->KategoriMateriUjian) == 'Qur\'an' ? 'selected' : '' ?>>Qur'an</option>
                                                <option value="Hafalan" <?= old('KategoriMateriUjian', $nilai->KategoriMateriUjian) == 'Hafalan' ? 'selected' : '' ?>>Hafalan</option>
                                                <option value="Tajwid" <?= old('KategoriMateriUjian', $nilai->KategoriMateriUjian) == 'Tajwid' ? 'selected' : '' ?>>Tajwid</option>
                                                <option value="Praktik" <?= old('KategoriMateriUjian', $nilai->KategoriMateriUjian) == 'Praktik' ? 'selected' : '' ?>>Praktik</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="TypeUjian" name="TypeUjian" required>
                                                ...
                                                <option value="munaqosah" <?= old('TypeUjian', $nilai->TypeUjian) == 'munaqosah' ? 'selected' : '' ?>>Munaqosah</option>
                                                <option value="pra-munaqosah" <?= old('TypeUjian', $nilai->TypeUjian) == 'pra-munaqosah' ? 'selected' : '' ?>>Pra-Munaqosah</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="Catatan" name="Catatan" rows="3"><?= old('Catatan', $nilai->Catatan) ?></textarea>
                                        </div>
                                    </div>
                                </div>
