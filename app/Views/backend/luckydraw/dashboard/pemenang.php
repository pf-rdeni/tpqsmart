            ...
            <table class="ld-table" style="text-align:center;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="status-badge status-taken" style="font-size:0.85rem;"><?= $stat['diambil'] ?></span></td>
                        <td><span class="status-badge status-pending" style="font-size:0.85rem;"><?= $stat['belum'] ?></span></td>
