    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-2 col-6">
                    <a href="<?= base_url('/backend/tpq/create/') ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                </div>
                    ...
                    foreach ($tpq as $dataTpq) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('/backend/tpq/delete/' . $dataTpq['IdTpq']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin Akan Delet Data Ini')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('/backend/tpq/update/'. $dataTpq['IdTpq']) ?>" method="POST">
...
<div class="modal fade" id="ProfilTpqModalInput" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <form action="<?= base_url('/backend/tpq/save') ?>" method="POST">
                    <div class="form-group">
                        <label for="FormProfilTpq">NIS TPQ</label>
