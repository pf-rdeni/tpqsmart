...
class AuthController extends Controller
{
    ...
    public function login()
    {
        ...
        $data = [
            'config' => $this->config,
            'page_title' => 'Login Page', // Tambahkan page_title
        ];
    ...
    public function attemptLogin()
    {
        ...
        if ($idGuru != null) {
            ...
            foreach ($dataGuruKelas as $dataGuru) {
                ...
                $IdTahunAjaran[] = $dataGuru->IdTahunAjaran;
    ...
    public function register()
    {
        ...
        // Tambahkan variabel page_title
        $data = [
            'config' => $this->config,
            'page_title' => 'Register Page', // Tambahkan page_title
        ];

        // Render view register dengan data
